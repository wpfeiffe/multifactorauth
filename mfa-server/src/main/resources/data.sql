...
INSERT INTO user_account(username, email, password, first_name, last_name, active, totp_code)
VALUES ('wpfeiffe', 'bill.pfeiffer@retrospect.com', '{noop}Password1', 'Bill', 'Pfeiffer', true, '123456');
INSERT INTO user_account(username, email, password, first_name, last_name, active, totp_code)
VALUES ('tsmith', 'tom.smith@retrospect.com', '{noop}Password1', 'Tom', 'Smith', true, '123456');
